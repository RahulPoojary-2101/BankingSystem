<?php
		...
		$conn = mysqli_connect("localhost", "id16401105_local", "AsL!xsZd*9_l*B{W", "id16401105_bank");
?>
<!DOCTYPE html>
<html>
<head>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <style type="text/css">
        ...
        body{
            background-image: url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZMPDZwOJQOQSzUZA9jIqKNFS03Kv4dPxihw&usqp=CAU");
